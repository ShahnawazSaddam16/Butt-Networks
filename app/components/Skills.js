...
const getCapabilities = (isDark) => [
  ...
  },
  {
    ...
    accentFrom: "#fb923c", accentTo: "#dc2626",
  ...
  {
    title: "Systems", emoji: "🔧",
    accentFrom: "#94a3b8", accentTo: "#475569",
          ...
          <span key={word} className="inline-block mr-3">
            <motion.span
              className={`inline-block ${
                isAccent
                  ? `bg-gradient-to-r ${
                      isDark ? "from-indigo-400 to-sky-400" : "from-blue-500 to-indigo-600"
                    } bg-clip-text text-transparent`
                  : ""
              }`}
              style={{ position: "relative" }}
              initial={prefersReduced ? false : { opacity: 0, y: 36, filter: "blur(10px)" }}
...
function CorePill({ item, index, isDark, isMobile, prefersReduced }) {
  ...
  return (
    <motion.div
      ref={ref}
      variants={variants}
      style={isMobile || prefersReduced ? {} : { x: springX, y: springY }}
      ...
      style={{
        ...
        // Promote to own layer to prevent repaint during scroll
...
function CapabilityCard({ cap, index, isDark, isMobile, prefersReduced }) {
  ...
  const variants = {
    ...
    show: {
      ...
      transition: { duration: isMobile ? 0.4 : 0.55, delay: index * 0.07, ease: [0.22, 1, 0.36, 1] },
    },
  };
  ...
  return (
    ...
    >
      <motion.article
        ...
        whileHover={prefersReduced ? {} : { scale: isMobile ? 1 : 1.015, transition: { duration: 0.2 } }}
        className={`relative rounded-2xl overflow-hidden group border h-full ${
          isDark ? "bg-gray-800 border-gray-700" : "bg-white border-gray-100"
        }`}
        style={{
          boxShadow: isDark ? "0 4px 24px rgba(0,0,0,0.3)" : "0 2px 16px rgba(0,0,0,0.07)",
        }}
      >
        ...
        <div className="relative h-[3px] w-full overflow-hidden">
          ...
          {!isMobile && !prefersReduced && (
            <motion.div
              ...
              transition={{ delay: index * 0.07 + 0.45, duration: 0.65, ease: "easeInOut" }}
            />
          )}
        </div>
        ...
        <div
          ...
          style={isMobile || prefersReduced ? {} : { transform: "translateZ(8px)" }}
        >
          <div className="flex items-center gap-3 mb-2.5">
            <motion.span
              ...
              whileHover={
                prefersReduced
                  ? {}
                  : { scale: 1.25, rotate: 10, transition: { type: "spring", stiffness: 380, damping: 14 } }
              }
            >
              {cap.emoji}
            </motion.span>
            ...
            {cap.tools.map((tool, ti) => (
              <motion.div
                ...
                whileHover={
                  prefersReduced
                    ? {}
                    : { scale: 1.08, y: -2, transition: { type: "spring", stiffness: 380, damping: 14 } }
                }
    ...
    >
      ...
      <div className="relative max-w-5xl mx-auto">
        ...
        <div ref={headerRef} className="text-center mb-16">
          ...
          <motion.div
            initial={prefersReduced ? false : { opacity: 0, y: -18, scale: 0.92 }}
        ...
        <div className="mb-16" ref={coreRef}>
          <SectionLabel emoji="⚡" label="Core Technologies" isDark={isDarkMode} inView={coreInView} />
        ...
        {/* ── Capabilities ── */}
        <div ref={capsRef}>
          <SectionLabel emoji="🎯" label="Capabilities" isDark={isDarkMode} inView={capsInView} />
